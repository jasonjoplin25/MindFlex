...
const SudokuGameWrapper = () => {
  ...
  const startNewGame = useCallback(async () => {
    ...
    try {
      ...
      console.log('Started Sudoku game session:', session);
    } catch (err) {
  ...
  const handleGameComplete = useCallback(async (gameData) => {
    ...
    try {
      console.log('Sudoku game completed:', gameData);
          ...
          <Card sx={{
            ...
            <CardContent sx={{ p: 4, textAlign: 'center' }}>
              ...
              <FormControl fullWidth sx={{ mb: 4 }}>
                ...
                >
                  <MenuItem value="easy">Easy - More filled cells, 5 hints</MenuItem>
                  <MenuItem value="medium">Medium - Some filled cells, 3 hints</MenuItem>
                  <MenuItem value="hard">Hard - Few filled cells, 1 hint</MenuItem>
                </Select>
              </FormControl>
    ...
    <Box>
      ...
      >
        ...
        <DialogContent>
          ...
          {gameSession && completionData && (
            <ScoreSubmission
              open={true}
              onClose={handleScoreSubmitted}
              gameData={{ name: game?.name || 'Sudoku' }}
              scoreData={{
                score: completionData.score,
